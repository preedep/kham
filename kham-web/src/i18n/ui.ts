...
export const ui = {
  en: {
    ...
    'gs.subtitle': 'kham v0.8.0 — pick your target and be up and running in minutes.',
    'gs.install': 'Install',
    'gs.usage': 'Usage',
  ...
  th: {
    ...
    'gs.subtitle': 'kham v0.8.0 — เลือกแพลตฟอร์มที่ต้องการและเริ่มใช้งานได้ภายในไม่กี่นาที',
    'gs.install': 'ติดตั้ง',
    'gs.usage': 'การใช้งาน',
