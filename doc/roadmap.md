...
- [ ] **kham-sqlite v2** — synonym expansion via `FTS5_TOKEN_COLOCATED`, normalization, stopword filtering, soundex codes (lk82/udom83/MetaSound) emitted as colocated tokens for phonetic-fuzzy search
