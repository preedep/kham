...
export const ui = {
  en: {
    ...
    'home.features.fast.body': 'Maximal Matching on a compressed DAWG dictionary. Achieves 33–34 MiB/s segmentation throughput on Apple M-series with F1 1.000 on 228 curated test cases.',
    ...
    'gs.subtitle': 'kham v0.6.0 — pick your target and be up and running in minutes.',
    'gs.install': 'Install',
    'gs.usage': 'Usage',
  ...
  th: {
    ...
    'home.features.fast.body': 'Maximal Matching บน DAWG dictionary ที่บีบอัดแล้ว ทำงานได้ 33–34 MiB/s บน Apple M-series ความแม่นยำ F1 1.000 บน 228 test cases',
    ...
    'gs.subtitle': 'kham v0.6.0 — เลือกแพลตฟอร์มที่ต้องการและเริ่มใช้งานได้ภายในไม่กี่นาที',
    'gs.install': 'ติดตั้ง',
    'gs.usage': 'การใช้งาน',
